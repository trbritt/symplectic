...
void initializeCUDA(int argc, char** argv, int& devID, int& numberPoints, sMatrixSize& matrix_size)
{
    ...
    int block_size = 32;
    //REQUIRE numberPoints to be power of 2
    matrix_size.uiWA = 6 * numberPoints * block_size ;
    matrix_size.uiHA = 6 * numberPoints * block_size ;
    matrix_size.uiWB = 1 ;
    matrix_size.uiHB = 6 * numberPoints * block_size ;
    matrix_size.uiWC = 1 ;
    matrix_size.uiHC = 6 * numberPoints * block_size ;
